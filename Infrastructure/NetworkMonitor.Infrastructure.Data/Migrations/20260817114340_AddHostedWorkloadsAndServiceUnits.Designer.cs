...
namespace NetworkMonitor.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260817114340_AddHostedWorkloadsAndServiceUnits")]
    partial class AddHostedWorkloadsAndServiceUnits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NetworkMonitor.Domain.Device", b =>
                {
                    ...
                    b.Property<DateTime?>("LastFingerprintedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("NetworkMonitor.Domain.RawMetric", b =>
                {
                    ...
                    b.HasIndex(new[] { "JobId" }, "IX_RawMetrics_JobId");
